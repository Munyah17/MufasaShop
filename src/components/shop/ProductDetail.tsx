      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            {product.stock_quantity > 0 ? (
              <div className="space-y-4">
                ...
                <Button variant="gold" size="lg" fullWidth onClick={handleAddToCart} className="text-base">
                  <ShoppingBag size={18} />
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              {[
                ...
                <div key={text} className="flex items-center gap-2 p-3 bg-obsidian-800 rounded-lg border border-obsidian-700">
            ...
            {product.specs && Object.keys(product.specs).length > 0 && (
              <div className="bg-obsidian-800 rounded-xl border border-obsidian-700 overflow-hidden">
                <div className="px-4 py-3 border-b border-obsidian-700">
                  <h3 className="font-display font-semibold text-obsidian-100 text-sm">Specifications</h3>
                </div>
                <div className="divide-y divide-obsidian-700">
                  {Object.entries(product.specs).map(([key, value]) => (
                    <div key={key} className="flex px-4 py-2.5 gap-4">
                      <span className="text-obsidian-500 text-xs font-medium w-28 shrink-0">{key}</span>
        ...
        {product.description && (
          <div className="mt-16 max-w-3xl">
            <h2 className="font-display font-bold text-2xl text-obsidian-50 mb-4">Product Details</h2>
