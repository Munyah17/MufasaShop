  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative w-full px-5 sm:px-10 lg:px-16 xl:px-24 pt-28 pb-20">
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20 min-w-0">
            {/* Text */}
            ...
            <div className="flex-1 min-w-0 flex justify-center lg:justify-end w-full">
              <div className="relative w-full max-w-[280px] sm:max-w-sm lg:max-w-[480px] aspect-square">
